...
$(document).delegate('#doneSubmit-e', 'click', function() {
	...
	if(flag==0){
		...
		var sendStr = printStr+'&'+printStr2+'&'+printStr3+'&'+printStr4+'&'+printStr5+'&'+printStr6+'&patID='+getUrlVars()['id'];		
...
function editUserInit(){	
	...
	$.getJSON(url,{ id: getUrlVars()['id']},function(data){
...
function EditUserFormInit(type,location,abrev,num){
	...
	$.getJSON(url,function(data){
		...
		showStr += '<li><input type="button" data-inline="true" value="Next" id="nf'+type+'Next-e"/></li>';
