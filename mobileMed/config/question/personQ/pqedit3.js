...
$(document).delegate('#pqEditTest3', 'click', function() {
	//$('#pqedit3_1').hide();
	//alert("pressed2");
});

$(document).delegate('#pqEditSave3', 'click', function() {
	alert("pressed");
});
...
function PQ_InitEdit3(){
	...
	/*console.log(sessionStorage.pqedit2_type)
	console.log(sessionStorage.pqedit2_pos)
	console.log(sessionStorage.pqedit2_id)*/
