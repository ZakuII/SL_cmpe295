...
//question
class Controller_question_MiscQuest extends Controller {
	...
	public function action_postShow(){
		...
		for ($i=0; $i<sizeof($parsedpqid); $i++){
			...
			$personA = new Model_MiscQuestion($parsedpqid[$i]);
    ...
    public function action_getAnswer(){
    	...
    	if(isset($_GET['id'])){
    		...
    		$personQ = ORM::factory('MiscQuest')->find_all(); 
