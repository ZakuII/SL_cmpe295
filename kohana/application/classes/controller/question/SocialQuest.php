...
//question
class Controller_question_SocialQuest extends Controller {
	...
	//update new question ANSWER
	 public function action_post() {
	 	...
	 	$personA = new Model_SocialAnswer();
	...
	public function action_postShow(){
		...
		for ($i=0; $i<sizeof($parsedpqid); $i++){
			...
			$personA = new Model_SocialQuestions($parsedpqid[$i]);
	...
	public function action_getAnswer(){
    	...
    	if(isset($_GET['id'])){
    		...
    		$personQ = ORM::factory('SocialQuestions')->find_all(); 
    		$personA = new Model_SocialAnswer($_GET['id']);
	    	$tblSize = sizeof($personQ);
    		$tblCnt = 0;    	
