...
//question
class Controller_question_MedicalQuest extends Controller {
	...
	//update new question ANSWER
	 public function action_post() {
	 	...
	 	$personA = new Model_MedicalAnswer();
	...
	public function action_postShow(){
		...
		for ($i=0; $i<sizeof($parsedpqid); $i++){
			...
			$personA = new Model_MedicalQuestion($parsedpqid[$i]);
    ...
    public function action_getAnswer(){
    	...
    	if(isset($_GET['id'])){
    		...
    		$personQ = ORM::factory('MedicalQuest')->find_all(); 
    		$personA = new Model_MedicalAnswer($_GET['id']);
	    	$tblSize = sizeof($personQ);
    		$tblCnt = 0;
